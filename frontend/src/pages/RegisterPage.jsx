    ...
    <div className="min-h-screen bg-[#FFFDF9] flex items-center justify-center p-4">
      <div className="bg-white p-8 rounded-3xl border border-amber-200 shadow-xl max-w-md w-full">
        <div className="text-center mb-6">
          ...
          <h2 className="text-2xl font-bold text-gray-900">Join Tvarita</h2>
          <p className="text-xs text-gray-500">Create an account to support & document cultural heritage</p>
        </div>
        ...
        <p className="mt-6 text-center text-xs text-gray-600">
          Already have an account? <Link to="/login" className="text-[#E65100] font-bold hover:underline">Sign In</Link>
        </p>
      </div>
    </div>
  );
